	...
	Colorpicker.prototype = {
		...
		render: function () {
			var tpl =
				...
				<div style="position: inherit; height: 255px; padding: 8px; border-radius: 3px; background: #fff; z-index: 100; display: flex; box-shadow: rgba(0, 0, 0, 0.3) 0px 0px 2px, rgba(0, 0, 0, 0.3) 0px 4px 8px;">
