			...
			<form action="" method="post" class="layui-form" lay-filter="component-layui-form-item" enctype="multipart/form-data" >
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="parameter[kdniao_id]" class="form-control" value="<?php echo ($data['kdniao_id']); ?>" />
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="parameter[kdniao_api_key]" class="form-control" value="<?php echo ($data['kdniao_api_key']); ?>" />
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="parameter[kdn_sender_name]" class="form-control" value="<?php echo ($data['kdn_sender_name']); ?>" maxlength="30"/>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="parameter[kdn_sender_mobile]" class="form-control" value="<?php echo ($data['kdn_sender_mobile']); ?>"  maxlength="20"/>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="parameter[kdn_sender_address]" class="form-control" value="<?php echo ($data['kdn_sender_address']); ?>" maxlength="100"/>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="parameter[kdn_sender_company]" class="form-control" value="<?php echo ($data['kdn_sender_company']); ?>"  maxlength="30"/>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="parameter[kdn_sender_postcode]" class="form-control" value="<?php echo ($data['kdn_sender_postcode']); ?>"  maxlength="10"/>
...
<script>
	$(function(){
		cascdeInit("1","1","<?php echo ($data['kdn_province_id']); ?>","<?php echo ($data['kdn_city_id']); ?>","<?php echo ($data['kdn_area_id']); ?>","");
	});
