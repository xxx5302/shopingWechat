						...
						<table class="table table-responsive" lay-even lay-skin="line" lay-size="lg">
							...
							<td>
								<?php if( $item['grounding']==4 || $item['grounding']==5){ ?>
									...
									<?php } ?>
								<?php  }else{ ?>
									<?php if( defined('ROLE') && ROLE == 'agenter' && $is_open_shenhe == 1 && $is_updown == 0){ ?>
						...
						<?php } ?>
							...
							<?php } ?>
								...
								<td  style="overflow:visible;position:relative">
									...
									<a href="javascript:;" class="js-clip layui-btn layui-btn-xs" data-url="/lionfish_comshop/pages/goods/goodsDetail?id=<?php echo ($item['id']); ?>"><i class="layui-icon">&#xe64c;</i>小程序链接</a>
									<a  class='layui-btn layui-btn-xs copy' href="javascript:;" data-href="<?php echo U('goods/copy',array('id' => $item['id']));?>" data-confirm='确认复制商品吗?'>
										<i class="layui-icon">&#xe605;</i>复制新建商品
									</a>
								</td>
							</tr>
							<?php } ?>
	...
	<div class="layui-card">
	  <div class="layui-card-body">
			<div class="modal-body" >
				...
				<div class="layui-form-item">
                    <label class="layui-form-label">仅这个团长分组可售</label>
                    <div class="layui-input-block">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10 col-xs-12">
						...
						<div class="all_heads_tip" style="display: none;">
							<span style="color: #999;">所有商品中包含“所有团长可售”商品，建议取消以免设置失效</span>
						</div>
                    </div>
                </div>
