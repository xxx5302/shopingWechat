					...
					<div class="col-md-12">
						...
						<table class="table table-responsive" lay-even lay-skin="line" lay-size="lg">
							...
							<tr>
								...
								<td> 
								<?php echo ($row['community_name']); ?><br/>
								...
								<td>
									...
									<?php if( $row['state'] == 0 ){ ?>	
												<a class='op layui-btn layui-btn-xs'  data-toggle="ajaxModal" href="javascript:;" data-href="<?php echo U('communityhead/agent_check_first', array('id' => $row['id']));?>" >
											...
											<input type="checkbox" name="" lay-filter="statewsitchunable" data-href="<?php echo U('communityhead/agent_check', array('id'=>$row['id']));?>" <?php if($row['state']==1){ ?>checked<?php } ?> lay-skin="switch" lay-text="已拒绝|拒绝">
