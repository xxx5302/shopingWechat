...
<div class="layui-fluid">
	<div class="layui-card">
		<div class="layui-card-header layui-elem-quote">当前位置：<span class="line-text"><?php if( !empty($item['id'])){ ?>编辑<?php  }else{ ?>添加<?php } ?>团长 <small><?php if( !empty($item['id'])){ ?>修改【<?php echo ($item['head_name']); ?>】<?php } ?></small></span></div>
		<div class="layui-card-body" style="padding:15px;">
			<form action="" method="post" class="layui-form" lay-filter="component-layui-form-item" enctype="multipart/form-data" >
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<div class="input-group " style="margin: 0;">
							<input type="text" disabled value="<?php echo ($agent_saler['member_id']); ?>" class="form-control valid" name="agent_id" placeholder="" id="agent_id">
							<span class="input-group-btn">
						...
						<div class="input-group " style="margin: 0;">
							<div class="layadmin-text-center choose_user">
								<img style="" src="<?php echo ($agent_saler['avatar']); ?>">
								<div class="layadmin-maillist-img" style=""><?php echo ($agent_saler['nickname']); ?></div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="head_name" class="form-control" value="<?php echo ($item['head_name']); ?>" data-rule-required="true" />
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="head_mobile" class="form-control" value="<?php echo ($item['head_mobile']); ?>" data-rule-required="true"  />
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="community_name" class="form-control" value="<?php echo ($item['community_name']); ?>"  data-rule-required="true" />
						<span class='layui-form-mid'></span>
					</div>
				</div>
						...
						<div class="dEdit_1">
							<div class="layui-inline">
								...
								<div class="layui-input-inline" style="width: 200px;">
									<input type="text" style="width: 200px;" name="address" id="address"  data-val="true" data-val-required="请填写社区店所在详细地址" class="form-control" value="<?php echo ($item['address']); ?>" data-rule-required="true"  />
								</div>
					...
					<div class="layui-input-block">
						<div class="dEdit_1">
							<div class="layui-inline">
								...
								<div class="layui-input-inline" style="width: 100px;">
									<input class="form-control input-sm" data-val="true"   id="lon" name="lon"  type="text" value="<?php echo ($item['lon']); ?>">
								</div>
								
								<div class="layui-input-inline" style="width: 100px;">
									<input class="form-control input-sm" data-val="true" id="lat" name="lat"  type="text" value="<?php echo ($item['lat']); ?>">
								</div>
							</div>
						...
						<td>
										<?php if( $item['state'] == 0 ){ ?>
											...
											<input type="hidden" name="state" value="0" />
												<a style="display:inline;" class='op layui-btn layui-btn-xs'  data-toggle="ajaxModal" href="javascript:;" data-href="<?php echo U('communityhead/agent_check_first', array('id' => $item['id']));?>" >
											...
											<p style="color: red; display:inline;padding-right: 15px;"></p>
												...
												<input type="checkbox" name="" lay-filter="statewsitchunable" data-href="<?php echo U('communityhead/agent_check', array('id'=>$item['id']));?>" <?php if($item['state']==1){ ?>checked<?php } ?> lay-skin="switch" lay-text="已拒绝|拒绝">
										...
										<?php }else if( $item['state'] == 2 ){ ?>
											...
											<a style="display:inline;" data-toggle="ajaxModal" href="javascript:;" data-href="<?php echo U('communityhead/agent_check_first', array('id' => $item['id']));?>" >
				...
				<div class="layui-form-item">
					<label class="layui-form-label must"> <?php echo ($wechat_div); ?></label>
					<div class="layui-input-block">
						<input type="text" name="wechat" class="form-control" value="<?php echo ($item['wechat']); ?>"/>
						<span class='layui-form-mid'></span>
					<!--
					<?php if( !empty($item['wechat']) ){ ?>
						<span class='layui-form-mid'><?php echo ($item['wechat']); ?></span>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="bankname"  class="form-control" value="<?php echo ($item['bankname']); ?>"   />
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="bankaccount"  class="form-control" value="<?php echo ($item['bankaccount']); ?>"   />
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="bankusername"  class="form-control" value="<?php echo ($item['bankusername']); ?>"   />
						<span class='layui-form-mid'>需有关联会员此处设置才有效</span>
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<?php echo tpl_form_field_image2('share_wxcode', $item['share_wxcode']);?>
...
layui.use(['jquery', 'layer','form'], function(){ 
  ...
  var form = layui.form;
	...
	$('#chose_agent_id').click(function(){
		cur_open_div = $(this).attr('data-input');
		$.post("<?php echo U('communityhead/query_head_user_agent', array('ok' => 1));?>", {}, function(shtml){
		 layer.open({
			type: 1,
			area: '930px',
			content: shtml //注意，如果str是object，那么需要字符拼接。
		...
		success: function (info) {
			...
			if(info.status == 0)
			{
				...
				layer.msg('操作成功',{time: 1000,
						...
						var backurl = "<?php echo U('communityhead/index',array('ok'=>'1'));?>";
...
var initMap = function () {
	<?php if( !empty($item['lat']) ){ ?>
		var center = new qq.maps.LatLng(<?php echo ($item['lat']); ?>,<?php echo ($item['lon']); ?>);
	<?php }else{?>
