			...
			<form action="" method="post" class="layui-form" lay-filter="component-layui-form-item" enctype="multipart/form-data" >
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						...
						<span class='help-block'>示例：https://域名/ ，网址最后的“/”必填，未配置https的，需要配置https</span>
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						...
						<input type="radio" name="parameter[index_list_theme_type]" value="3" title="一行两个商品" <?php if( empty($data) || $data['index_list_theme_type'] ==3 ){ ?>checked <?php } ?> />
						<input type="radio" name="parameter[index_list_theme_type]" value="2" title="一行三个商品" <?php if( empty($data) || $data['index_list_theme_type'] ==2 ){ ?>checked <?php } ?> />
					</div>
				</div>
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<div class="" style="margin:0px;">
							...
							<div class="layui-inline" style="left: -11px;">
							  <div id="minicolors" class="layui-inline">
								  <div class="layui-unselect layui-colorpicker"><span><span class="layui-colorpicker-trigger-span" lay-type="" style="background: <?php echo ($data['nav_bg_color']); ?>"><i class="layui-icon layui-colorpicker-trigger-i layui-icon-down"></i></span></span></div>
							  </div>
							</div>
						  </div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<div class="" style="margin:0px;">
							...
							<div class="layui-inline" style="left: -11px;">
							  <div id="skincolors">
								  <div class="layui-unselect layui-colorpicker"><span><span class="layui-colorpicker-trigger-span" lay-type="" style="background: <?php echo ($data['skin']); ?>"><i class="layui-icon layui-colorpicker-trigger-i layui-icon-down"></i></span></span></div>
							  </div>
							</div>
						  </div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<div class="" style="margin:0px;">
							...
							<div class="layui-inline" style="left: -11px;">
							  <div id="minicolors2">
								  <div class="layui-unselect layui-colorpicker"><span><span class="layui-colorpicker-trigger-span" lay-type="" style="background: <?php echo ($data['index_top_font_color']); ?>"><i class="layui-icon layui-colorpicker-trigger-i layui-icon-down"></i></span></span></div>
							  </div>
							</div>
						  </div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<div class="" style="margin:0px;">
							...
							<div class="layui-inline" style="left: -11px;">
							  <div id="minicolors3">
								  <div class="layui-unselect layui-colorpicker"><span><span class="layui-colorpicker-trigger-span" lay-type="" style="background: <?php echo ($data['user_top_font_color']); ?>"><i class="layui-icon layui-colorpicker-trigger-i layui-icon-down"></i></span></span></div>
							  </div>
							</div>
						  </div>
						<span class='layui-form-mid'>默认：#ffffff</span>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
					  <input type="radio" name="parameter[fetch_coder_type]" value="0" title="页面底部" <?php if( empty($data) || $data['fetch_coder_type'] ==0 ){ ?>checked <?php } ?> />
					  <input type="radio" name="parameter[fetch_coder_type]" value="1" title="右上角图标" <?php if( !empty($data) && $data['fetch_coder_type'] ==1 ){ ?>checked <?php } ?> />
					  <input type="radio" name="parameter[fetch_coder_type]" value="2" title="不显示" <?php if( !empty($data) && $data['fetch_coder_type'] ==2 ){ ?>checked <?php } ?> />
					</div>
				</div>
				...
				<div class="layui-form-item">
					<label class="layui-form-label">个人中心自提点路线按钮</label>
					<div class="layui-input-block">
					  	<input type="radio" name="parameter[show_user_change_comunity_map]" value="0" title="隐藏" <?php if( empty($data) || $data['show_user_change_comunity_map'] ==0 ){ ?>checked <?php } ?> />
						<input type="radio" name="parameter[show_user_change_comunity_map]" value="1" title="显示" <?php if( !empty($data) && $data['show_user_change_comunity_map'] ==1 ){ ?>checked <?php } ?> />
						<br />
					  <span class='layui-form-mid'>点击跳转显示自提点地图位置信息，默认：关闭。</span>
					</div>
				</div>
				...
				<div class="layui-form-item">
					<label class="layui-form-label">公告点击弹窗</label>
					<div class="layui-input-block">
					  <input type="radio" name="parameter[can_index_notice_alert]" value="1" title="开启" <?php if( !empty($data) && $data['can_index_notice_alert']==1 ){ ?>checked <?php } ?> />
					  <input type="radio" name="parameter[can_index_notice_alert]" value="0" title="关闭" <?php if( empty($data) || $data['can_index_notice_alert']==0 ){ ?>checked <?php } ?> />
					  <br>
					  <span class='layui-form-mid'>首页公告点击弹窗显示详情，默认：关闭。</span>
					</div>
				</div>
...
<script>
	...
	$('#skincolors').colpick({
		...
		onSubmit: function(color,color2){
			...
			$('#skincolors').find('.layui-colorpicker-trigger-span').css('background','#'+color2);
			$('.colpick_full').hide();
		}
	});
	...
	$('#minicolors2').colpick({
		...
		onSubmit: function(color,color2){
			...
			$('#minicolors2').find('.layui-colorpicker-trigger-span').css('background','#'+color2);
			$('.colpick_full').hide();
		}
	});
	...
	$('#minicolors3').colpick({
		...
		onSubmit: function(color,color2){
			...
			$('#minicolors3').find('.layui-colorpicker-trigger-span').css('background','#'+color2);
			$('.colpick_full').hide();
		}
	});
