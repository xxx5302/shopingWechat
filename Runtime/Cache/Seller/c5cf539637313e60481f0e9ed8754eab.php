		...
		<div class="layui-card-body" style="padding:15px;">
			<form action="" method="post" class="layui-form" lay-filter="component-layui-form-item" enctype="multipart/form-data" >
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<label class="radio-inline"><input lay-ignore type="checkbox" name="data[commiss_tixianway_yuer]" value="2" <?php if(!isset($data['commiss_tixianway_yuer']) || ( isset($data['commiss_tixianway_yuer']) && $data['commiss_tixianway_yuer'] ==2)){ ?> checked="checked" <?php } ?> title="" /> 系统余额(只能用于小程序消费)</label>
						<br/>
						<label class="radio-inline"><input lay-ignore type="checkbox" name="data[commiss_tixianway_weixin]" value="2" <?php if(!isset($data['commiss_tixianway_weixin']) || (isset($data['commiss_tixianway_weixin']) && $data['commiss_tixianway_weixin'] ==2)){ ?> checked="checked" <?php } ?> title="" /> 微信零钱(需先开通企业付款接口，一般实时到账)</label>
						<br/>
						<label class="radio-inline"><input lay-ignore type="checkbox" name="data[commiss_tixianway_alipay]" value="2" <?php if(!isset($data['commiss_tixianway_alipay']) || (isset($data['commiss_tixianway_alipay']) && $data['commiss_tixianway_alipay'] ==2)){ ?> checked="checked" <?php } ?> title="" /> 支付宝(手动)</label>
						<br/>
						<label class="radio-inline"><input lay-ignore type="checkbox" name="data[commiss_tixianway_bank]" value="2" <?php if( !isset($data['commiss_tixianway_bank']) || (isset($data['commiss_tixianway_bank']) && $data['commiss_tixianway_bank'] ==2 ) ){ ?> checked="checked" <?php } ?> title="" /> 银行卡（手动）</label>
