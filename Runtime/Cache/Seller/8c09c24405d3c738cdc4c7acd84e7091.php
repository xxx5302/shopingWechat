					...
					<div class="layui-input-block">
						<div class="" style="margin:0px;">
							...
							<div class="layui-inline" style="left: -11px;">
							  <div id="minicolors3">
								  <div class="layui-unselect layui-colorpicker"><span><span class="layui-colorpicker-trigger-span" lay-type="" style="background: <?php echo ($data['index_qgtab_bottom_color']); ?>"><i class="layui-icon layui-colorpicker-trigger-i layui-icon-down"></i></span></span></div>
							  </div>
							</div>
						  </div>
...
<script>
	...
	$('#minicolors3').colpick({
		submit:true,
		color: index_qgtab_bottom_color,
