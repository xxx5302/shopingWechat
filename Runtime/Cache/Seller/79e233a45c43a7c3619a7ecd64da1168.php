...
<div class="layui-fluid">
	<div class="layui-card">
		...
		<div class="layui-card-body" style="padding:15px;">
			...
			<div class="layui-form-item">
				<label class="layui-form-label">未登录未审核不显示价格</label>
				<div class="layui-input-block">
					<label class='radio-inline'>
						<input type='radio' name='data[is_login_showprice]' value='0' <?php if(!empty($data) && $data['is_login_showprice'] ==0){ ?>checked <?php } ?> title="显示" />
					</label>
					<label class='radio-inline'>
						<input type='radio' name='data[is_login_showprice]' value='1' <?php if(empty($data) || $data['is_login_showprice'] ==1){ ?>checked <?php } ?> title="不显示" />
					</label>
				</div>
			</div>
