						...
						<table cellpadding="0" cellspacing="0" border="0" style="background-color:#fff;">
							...
							<?php foreach($list2 as $k => $w){ ?>	
								<tr>
									...
									<?php
 $order_amount = $w['total']+$w['shipping_fare']+$w['packing_fare']-$w['voucher_credit']-$w['fullreduction_money']-$w['score_for_money']-$w['fare_shipping_free']; $order_amount = sprintf("%.2f",$order_amount); ?>	
									...
									<?php	 $order_ji = $order_amount - $w["dayquxiao"]; $order_ji = sprintf("%.2f",$order_ji); ?>	
