...
<div class="layui-fluid">
	<div class="layui-card">
		<div class="layui-card-header layui-elem-quote">当前位置：<span class="line-text">商品规格管理</span></div>
		<div class="layui-card-body" style="padding:15px;">
			<form action="" method="get" class="form-horizontal form-search layui-form" role="form">
				...
				<input type="hidden" name="a" value="goodsspec" />
					...
					<div class="col-md-12">
						<div class="page-table-header">
							...
							<span class="pull-right"> 
								<a href="<?php echo U('group/addspec', array('ok' => 1));?>" class="layui-btn layui-btn-sm"><i class="fa fa-plus"></i> 添加商品规格</a>
							</span>
							<div class="btn-group">
								<button class="btn btn-default btn-sm  btn-operation"  type="button" data-toggle='batch-remove' data-confirm="确认要删除吗?" data-href="<?php echo U('group/deletespec');?>">
									 删除
								</button>
							</div>
						</div>
							...
							<tbody>
								...
								<tr>
									...
									<td><?php echo ($row['name']); ?></td>
									 <td><?php echo ($row['value_str']); ?></td>
								   
									<td style="text-align: center;">
										<a  class='layui-btn layui-btn-xs' href="<?php echo U('group/editspec', array('id' => $row['id'], 'ok' => 1));?>"  >
											<i class="layui-icon">&#xe608;</i>编辑
										</a>
										<?php if( $row['id']!='default'){ ?>
											<a  class='layui-btn layui-btn-xs deldom' href="javascript:;" data-href="<?php echo U('group/deletespec', array('id' => $row['id']));?>" data-confirm='确认要删除吗?'>
