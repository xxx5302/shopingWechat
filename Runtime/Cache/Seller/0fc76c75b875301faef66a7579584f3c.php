			...
			<form action="" method="post" class="layui-form" lay-filter="component-layui-form-item" enctype="multipart/form-data" >
				...
				<div class="layui-form-item" >
					...
					<div class="layui-input-block">  
						<input type="radio"  name="data[seckill_is_open]" <?php if( !isset($data['seckill_is_open']) || $data['seckill_is_open'] ==0 ){ ?> checked <?php } ?> value="0" title="关闭" />
						<input type="radio"  name="data[seckill_is_open]" <?php if( isset($data['seckill_is_open']) && $data['seckill_is_open'] ==1 ){ ?> checked <?php } ?> value="1" title="开启" />
					</div>
				</div>
				...
				<div class="layui-form-item" >
					...
					<div class="layui-input-block">  
						<input type="radio"  name="data[seckill_is_show_index]" <?php if( !isset($data['seckill_is_show_index']) || $data['seckill_is_show_index'] ==0 ){ ?> checked <?php } ?> value="0" title="关闭" />
						<input type="radio"  name="data[seckill_is_show_index]" <?php if( isset($data['seckill_is_show_index']) && $data['seckill_is_show_index'] ==1 ){ ?> checked <?php } ?> value="1" title="开启" />
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="data[seckill_page_title]" class="form-control" value="<?php echo ($data['seckill_page_title']); ?>" data-rule-required="true"  />
					...
					<div class="layui-input-block">
						<div class="" style="margin:0px;">
							<div class="layui-input-inline" style="width: 120px;">
							  <input type="text" name="data[seckill_bg_color]" value="<?php echo ($data['seckill_bg_color']); ?>" placeholder="请选择颜色" class="layui-input" id="test-colorpicker-form-input">
							</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="data[seckill_share_title]" class="form-control" value="<?php echo ($data['seckill_share_title']); ?>" data-rule-required="true"  />
					</div>
				</div>
				...
				<div class="layui-form-item" >
					...
					<div class="layui-input-block">
						<?php echo tpl_form_field_image2('data[seckill_share_image]', $data['seckill_share_image']);?>
...
layui.use(['jquery', 'layer','form','colorpicker'], function(){ 
  ...
  var colorpicker = layui.colorpicker;
    ...
    colorpicker.render({
      elem: '#minicolors'
      ,color: '<?php echo ($data['seckill_bg_color']); ?>'
      ,done: function(color){
