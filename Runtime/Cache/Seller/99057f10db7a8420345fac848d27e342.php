                    ...
                    <div class="layui-input-block">
    					...
    					<div class="multi-img-details">
    						...
    						<label class="move_item"> 
    							<input type="checkbox" lay-ignore name="order_index" value="<?php echo ($val['field']); ?>" class="item_input" <?php if( $val['is_check'] ==1 ){ ?>checked<?php } ?> title=""  /><?php echo $val['title']; ?>&nbsp;&nbsp;&nbsp;&nbsp;
    						</label>
    						<?php  if( $i % 8 == 0 ) { echo '<br/><br/>'; } $i++; ?>
    						<?php } ?>	
    					</div>
                    </div>
				</div>
