								...
								<tr>
									...
									<td style="overflow: visible">
										<div rel="pop" style="display: flex"  >
										   <img class="img-40" src="<?php echo ($row['member_info']['avatar']); ?>" style='width:40px;height: 40px;border-radius:50%;border:1px solid #efefef;' />
									...
									<td> 
									<?php echo ($row['money']); ?><br/><text class='text-primary'><?php echo ($row['service_charge_money']); ?></text><br/>
									...
									<td>
										...
										<input type="checkbox" name="" lay-filter="statewsitch" tx_type="<?php echo $row['type'];?>" data-href="<?php echo U('distribution/agent_check_apply',array('id'=>$row['id']));?>" <?php if($row['state']==1){ ?>checked <?php } ?> lay-skin="switch" lay-text="已审核|未审核">
