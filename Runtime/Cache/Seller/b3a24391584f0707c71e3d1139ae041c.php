									...
									<li class="dd-item full" data-id="<?php echo ($row['id']); ?>">
										...
										<div class="dd-handle" >
											...
											<span class="pull-right">
												...
												<input type="checkbox" name="" lay-filter="enabledwsitch" data-href="<?php echo U('goods/category_enabled',array('id'=>$row['id']));?>" <?php if( $row['is_show']==1 ){ ?>checked<?php } ?> lay-skin="switch" lay-text="社区首页显示|社区首页隐藏">

												<input type="checkbox" name="" lay-filter="enabledtypewsitch" data-href="<?php echo U('goods/category_typeenabled',array('id'=>$row['id']));?>" <?php if( $row['is_type_show']==1 ){ ?>checked<?php } ?> lay-skin="switch" lay-text="独立分类页显示|独立分类页隐藏">
												
												<!--<input type="checkbox" name="" lay-filter="enabledexpresswsitch" data-href="<?php echo U('goods/category_expressenabled',array('id'=>$row['id']));?>" <?php if( $row['is_express_show']==1 ){ ?>checked<?php } ?> lay-skin="switch" lay-text="仅快递商品页显示|仅快递商品页隐藏">	-->											
												...
												<li class="dd-item full" data-id="<?php echo ($child['id']); ?>">
													<div class="dd-handle" style="width:100%;">
														...
														<span class="pull-right">
																...
																<input type="checkbox" name="" lay-filter="enabledwsitch" data-href="<?php echo U('goods/category_enabled',array('id'=>$child['id']));?>" <?php if( $child['is_show']==1 ){ ?>checked<?php } ?> lay-skin="switch" lay-text="社区首页显示|社区首页隐藏">
																<input type="checkbox" name="" lay-filter="enabledtypewsitch" data-href="<?php echo U('goods/category_typeenabled',array('id'=>$child['id']));?>" <?php if( $child['is_type_show']==1 ){ ?>checked<?php } ?> lay-skin="switch" lay-text="独立分类页显示|独立分类页隐藏">
																<!--<input type="checkbox" name="" lay-filter="enabledexpresswsitch" data-href="<?php echo U('goods/category_expressenabled',array('id'=>$child['id']));?>" <?php if( $child['is_express_show']==1 ){ ?>checked<?php } ?> lay-skin="switch" lay-text="仅快递商品页显示|仅快递商品页隐藏">-->
														...
														<ol class="dd-list" >
															...
															<li class="dd-item full" data-id="<?php echo ($third['id']); ?>" style="width: 715px;">
																<div class="dd-handle" style="width:100%;>
																	...
																	<input type="checkbox" name="" lay-filter="enabledwsitch" data-href="<?php echo U('goods/category_enabled',array('id'=>$third['id']));?>" <?php if( $third['is_show']==1 ){ ?>checked<?php } ?> lay-skin="switch" lay-text="社区首页显示|社区首页隐藏">
																	
																	<input type="checkbox" name="" lay-filter="enabledtypewsitch" data-href="<?php echo U('goods/category_typeenabled',array('id'=>$third['id']));?>" <?php if( $third['is_type_show']==1 ){ ?>checked<?php } ?> lay-skin="switch" lay-text="独立分类页显示|独立分类页隐藏">
																	<!--<input type="checkbox" name="" lay-filter="enabledexpresswsitch" data-href="<?php echo U('goods/category_expressenabled',array('id'=>$third['id']));?>" <?php if( $third['is_express_show']==1 ){ ?>checked<?php } ?> lay-skin="switch" lay-text="仅快递商品页显示|仅快递商品页隐藏">-->

																		<a class='btn btn-default btn-sm btn-operation btn-op' href="<?php echo U('goods/addcategory', array('id' => $third['id']));?>" title="修改" >
																		 <span data-toggle="tooltip" data-placement="top" title="" data-original-title="修改">
				    ...
				    <div class="layui-tab-item">
				    	<form action="" method="post" class="layui-form" lay-filter="component-layui-form-item" enctype="multipart/form-data" >
							<div class="layui-form-item">
		                        ...
		                        <span class="layui-form-mid" style="margin-left: 35px;">控制具体某个分类页面，底部导航栏是否显示</span>
			        		</div>
			        		<div class="layui-form-item">
								<label class="layui-form-label">首页文字分类</label>
								<div class="layui-input-block">
								  <input type="radio" name="parameter[hide_index_type]" value="1" title="隐藏" <?php if( !empty($data) && $data['hide_index_type']==1 ){ ?>checked <?php } ?> />
								  <input type="radio" name="parameter[hide_index_type]" value="0" title="显示" <?php if( empty($data) || $data['hide_index_type']==0 ){ ?>checked <?php } ?> />
								</div>
							</div>
