				...
				<div class="row">
					<div class="list-div list-tb-div">
						...
						<table cellpadding="0" cellspacing="0" border="0">
                            ...
                            <tbody>
								<?php $is_open_pintuan_orderprint = D('Home/Front')->get_config_by_name('is_open_pintuan_orderprint'); ?>
                                    ...
                                    <td colspan="10">
                                        <div class="tDiv ml10">
											...
											<div style='text-align:right;font-size:12px;display:inline-block;' >
												...
												<?php if(!empty($is_open_pintuan_orderprint) && $is_open_pintuan_orderprint ==1){ ?>
												...
												<?php if( in_array($item['order_status_id'], array(1,4,6,10,11,12,14)) && $is_can_nowrfund_order ){ ?>
													<a class='op'  data-toggle="ajaxModal" href="javascript:;" data-href="<?php echo U('order/oprefund_do', array('id' => $item['order_id']));?>" >
                                ...
                                <tr class="">
                                    ...
                                    <td>
										<div class="tDiv" >
												...
												<?php }else{ ?>
														<a class="text-primary user"><font style="color: #999;">会员名：</font><?php echo ($item['nickname']); ?></a>
												<?php } ?>
												<?php if( !empty($item['member_content']) ){ ?>
												 <br/><font class="text-danger"><?php echo ($item['member_content']); ?></font>
												<?php } ?>
