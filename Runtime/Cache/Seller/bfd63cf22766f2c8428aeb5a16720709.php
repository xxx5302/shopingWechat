			...
			<form action="" method="post" class="layui-form" lay-filter="component-layui-form-item" enctype="multipart/form-data" >
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						...
						<label class='radio-inline'>
							<input type='radio' name='parameter[tabbar_out_type]' title="商城" lay-filter="linktype" value="8" <?php if( $data['tabbar_out_type']==8 && !empty($data) ){ ?>checked<?php } ?> />
						</label>
					</div>
				</div>
				...
				<div class="layui-form-item" id="linkGroup" style="<?php if( $data['tabbar_out_type']==3 || $data['tabbar_out_type']==4 || $data['tabbar_out_type']==5 || $data['tabbar_out_type']==6 || $data['tabbar_out_type']==7 || $data['tabbar_out_type']==8){ ?>display: none;<?php } ?>">
					...
					<div class="layui-input-block">
						<div class="" style="margin:0px;">
							...
							<div class="layui-inline" style="left: -11px;">
							  <div id="minicolors">
								  <div class="layui-unselect layui-colorpicker"><span><span class="layui-colorpicker-trigger-span" lay-type="" style="background: <?php echo ($data['wepro_tabbar_selectedColor']); ?>"><i class="layui-icon layui-colorpicker-trigger-i layui-icon-down"></i></span></span></div>
							  </div>
							</div>
						  </div>
				...
				<div class="layui-form-item" >
					...
					<div class="layui-input-block">
						<div class="" style="margin:0px;">
							<div class="layui-input-inline" style="width: 120px;">
							  <input type="text" name="parameter[wepro_tabbar_bgColor]" value="<?php echo ($data['wepro_tabbar_bgColor']); ?>" placeholder="请选择颜色" class="layui-input" id="test-colorpicker-form-input2">
							</div>
							<div class="layui-inline" style="left: -11px;">
							  <div id="minicolors2">
								  <div class="layui-unselect layui-colorpicker"><span><span class="layui-colorpicker-trigger-span" lay-type="" style="background: <?php echo ($data['wepro_tabbar_bgColor']); ?>"><i class="layui-icon layui-colorpicker-trigger-i layui-icon-down"></i></span></span></div>
							  </div>
							</div>
						  </div>
						<span class='layui-form-mid'>颜色值，有效值为十六进制颜色。默认色值：#FFFFFF</span>
					</div>
				</div>
  ...
  var form = layui.form;
   ...
   form.on('radio(linktype)', function(data){
		if (data.value == 2) {
			$('#linkGroup').show();
			$('#appidGroup').show();
		} else if(data.value == 3 || data.value == 4 || data.value == 5 || data.value == 6 || data.value == 7 || data.value == 8){
			$('#linkGroup').hide();
			$('#appidGroup').hide();
		} else {
			$('#linkGroup').show();
