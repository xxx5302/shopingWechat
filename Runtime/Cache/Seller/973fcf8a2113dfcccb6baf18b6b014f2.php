...
<div class="layui-fluid">
	<div class="layui-card">
		...
		<div class="layui-tab layui-tab-brief" >
		  <ul class="layui-tab-title">
				...
				<li  <?php if( (empty($_GPC['state']) || $_GPC['state']=='-1' )&& $_GPC['state'] !='0' ){ ?>class="layui-this"<?php } ?>><a href="<?php echo U('order/orderaftersales', array('state' => -1));?>">全部申请</a></li>
 ...
 if($item['type'] == 'integral'){ ?>
											应收总款：<br/><?php echo round($item['total'] ,2);?>积分<?php if( !empty( $item['shipping_fare'] ) ){ ?>+运费:<?php echo round($item['shipping_fare'] ,2); } ?>
											<?php }else{ ?>
