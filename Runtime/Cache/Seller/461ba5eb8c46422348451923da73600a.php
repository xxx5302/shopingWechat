		...
		<div class="app-preview">
			...
			<div class="app-body">
				...
				<div class="main postera" id="app-preview">
					...
					<div class="avatar" <?php if( !empty($data['distribution_avatar_left']) || !empty($data['distribution_avatar_top']) ){ ?> style="position:absolute;left:<?php echo ($data['distribution_avatar_left']); ?>px;top:<?php echo ($data['distribution_avatar_top']); ?>px;" <?php } ?>>头像</div>
					<div class="qrcodes" <?php if(!empty($data['distribution_qrcodes_left']) || !empty($data['distribution_qrcodes_top']) ){ ?> style="position:absolute;left:<?php echo ($data['distribution_qrcodes_left']); ?>px;top:<?php echo ($data['distribution_qrcodes_top']); ?>px;" <?php } ?>>二维码</div>
					<div class="username" <?php if(!empty($data['distribution_username_left']) || !empty($data['distribution_username_top']) ){ ?> style="position:absolute;left:<?php echo ($data['distribution_username_left']); ?>px;top:<?php echo ($data['distribution_username_top']); ?>px;" <?php } ?>>会员昵称</div>
				</div>
			</div>
				...
				<div class="inner">
					<div class="form-group">
						...
						<div class="col-sm-9" id="bg_img">
							<?php echo tpl_form_field_image2('distribu_member_image', $data['distribution_img_src']);?>
					...
					<div class="form-group" >
						...
						<div class="col-sm-9 col-xs-12">
							<input type="text" name="commiss_avatar_rgb" class="form-control minicolors_avatar_rgb" value="<?php echo ($data['commiss_avatar_rgb']); ?>" />
					...
					<div class="form-group" >
						...
						<div class="col-sm-9 col-xs-12">
							<input type="text" name="commiss_nickname_rgb" class="form-control minicolors_nickname_rgb" value="<?php echo ($data['commiss_nickname_rgb']); ?>" />
	...
	<script>
		...
		$(function(){
			...
			$('#clear_haibao').click(function(){
				$.ajax({
					url:"<?php echo U('distribution/clear_haibao');?>",
					type:'post',
					dataType:'json',
					success:function(ret){
						alert('操作成功');
						 var backurl = "<?php echo U('distribution/qrcodeconfig',array('ok'=>'1'));?>";
			...
			$('#save_btn').click(function(){
				...
				$.ajax({
					url:"<?php echo U('distribution/qrcodeconfig');?>",
					type:'post',
					dataType:'json',
					data:post_obj,
					success:function(ret){
