                        ...
                        <td>
                         ...
                         <td>
                            <div class="layui-input-block" style="width: 80px;margin-left: 0;">
                              <input type="checkbox" name="status[]" lay-skin="switch" name="status[]" <?php if( $row['status']==1){ ?>checked<?php } ?> lay-text="显示|隐藏" value="1" <?php if( $row['status']==1){ ?>checked<?php } ?> >
                            </div>
                         </td>-->
                         <td>
                            <a  class='layui-btn layui-btn-xs deldom' href="javascript:;" data-href="<?php echo U('marketing/deletecategory', array('id' => $row['id']));?>" data-confirm='确认删除此优惠券吗？?'>
