				...
				<div class="layui-tab-content" style="height: 100%;">
					<form action="" method="post" class="layui-form" lay-filter="component-layui-form-item" enctype="multipart/form-data" >
						<div class="layui-form-item">
							...
							<span class='layui-form-mid' style="margin-left: 30px;">同城配送需要开启 <a href="<?php echo U('order/config');?>"  style="color:red;">redis</a> 才能正常使用。</span>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<div class="input-group fixsingle-input-group">
									<input class="form-control" name="parameter[localtown_outorder_time]" type="text" placeholder="" value="<?php echo ($data['localtown_outorder_time']); ?>">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<div class="input-group fixsingle-input-group">
									<input class="form-control" name="parameter[localtown_delivery_time]" type="text" placeholder="" value="<?php echo ($data['localtown_delivery_time']); ?>">
									<div class="input-group-addon">分</div>
								</div>
						...
						<div class="layui-form-item">
							...
							<div class='layui-input-block'>
								<div class="input-group fixsingle-input-group">
									<input class="form-control" name="parameter[localtown_delivery_packingmoney]" type="text" placeholder="" value="<?php echo ($data['localtown_delivery_packingmoney']); ?>">
									<div class="input-group-addon">元</div>
								</div>
								<div class="layui-form-mid layui-word-aux">设置商品统一包装费</div>
							</div>
						</div>
						-->
						<div class="layui-form-item" >
							<label class="layui-form-label">包装费自定义名称</label>
							<div class='layui-input-block'>
								<div class="radio-inline">
									<div class="layui-input-inline">
										<input type="text" name="parameter[localtown_modifypickingname]" value="<?php echo ($data['localtown_modifypickingname']); ?>" class="layui-input" />
									</div>
									<div class="layui-form-mid layui-word-aux">默认：包装费</div>
								</div>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class='layui-input-block'>
								<div class="input-group fixsingle-input-group">
									<input class="form-control" name="parameter[localtown_servvice_maxdistance]" id="servvice_maxdistance" type="text" placeholder="" value="<?php echo ($data['localtown_servvice_maxdistance']); ?>">
						...
						<div class="layui-form-item" id="fixed_deliverymoney_set" <?php if( isset($data['localtown_delivery_moneytype']) && $data['localtown_delivery_moneytype'] ==1 ){ ?> style="display:none; <?php } ?>>
							...
							<div class="layui-input-block">
								<div class="input-group fixsingle-input-group">
									...
									<input class="form-control" id="fixed_money" name="parameter[localtown_moneytype_fixed_money]" type="text" placeholder="" value="<?php echo ($data['localtown_moneytype_fixed_money']); ?>">

									<div class="input-group-addon">起送价格</div>
									<input class="form-control" id="fixed_deliverymoney" name="parameter[localtown_moneytype_fixed_deliverymoney]" type="text" placeholder="" value="<?php echo ($data['localtown_moneytype_fixed_deliverymoney']); ?>">
									<div class="input-group-addon">元，达到</div>
									<input class="form-control" id="fixed_freemoney" name="parameter[localtown_moneytype_fixed_freemoney]" type="text" placeholder="" value="<?php echo ($data['localtown_moneytype_fixed_freemoney']); ?>">
						...
						<div class="layui-form-item" id="basedistance_deliverymoney_set" <?php if(!isset($data['localtown_delivery_moneytype']) || $data['localtown_delivery_moneytype'] ==0){ ?> style="display:none;" <?php } ?>>
							...
							<div class="layui-input-block">
								<div class="input-group fixsingle-input-group">
									...
									<input class="form-control" name="parameter[localtown_moneytype_basedistance_deliverymoney]" type="text" placeholder="" value="<?php echo ($data['localtown_moneytype_basedistance_deliverymoney']); ?>">
									<div class="input-group-addon">元，超过</div>
									<input class="form-control" name="parameter[localtown_moneytype_basedistance]" type="text" placeholder="" value="<?php echo ($data['localtown_moneytype_basedistance']); ?>">
									<div class="input-group-addon">KM , 超过每KM增加</div>
									<input class="form-control" name="parameter[localtown_moneytype_base_perkmaddmoney]" type="text" placeholder="" value="<?php echo ($data['localtown_moneytype_base_perkmaddmoney']); ?>">
									<div class="input-group-addon">元 , 最高收取</div>
									<input class="form-control" name="parameter[localtown_moneytype_base_maxdeliverymoney]" type="text" placeholder="" value="<?php echo ($data['localtown_moneytype_base_maxdeliverymoney']); ?>">
									<div class="input-group-addon">元</div>
								</div>
						...
						<div class="layui-form-item">
							...
							<div class='layui-input-block'>
								<div class="input-group fixsingle-input-group">
									<input class="form-control" name="parameter[localtown_confirm_delivery_distance]" type="text" placeholder="" value="<?php echo ($data['localtown_confirm_delivery_distance']); ?>">
						...
						<div class="layui-form-item">
							...
							<div class='layui-input-block'>
								<div class="input-group fixsingle-input-group">
									<input class="form-control" name="parameter[localtown_grabbing_distance]" type="text" placeholder="" value="<?php echo ($data['localtown_grabbing_distance']); ?>">
									<div class="input-group-addon">m</div>
								</div>
						...
						<div class="layui-form-item" style="display:none;">
							...
							<div class='layui-input-block'>
								<div class="input-group fixsingle-input-group">
									<input class="form-control" name="parameter[localtown_makeup_delivery_money]" type="text" placeholder="" value="<?php echo ($data['localtown_makeup_delivery_money']); ?>">
									<div class="input-group-addon">元</div>
								</div>
						...
						<div class="layui-form-item">
							...
							<div class='layui-input-block'>
								<div class="radio-inline">
									<div class="layui-input-inline">
										<input type="text" name="parameter[localtown_shop_telephone]" value="<?php echo ($data['localtown_shop_telephone']); ?>" class="layui-input" />
									</div>
								...
								<div class="dEdit_1">
									<div class="layui-inline">
										...
										<div class="layui-input-inline" style="width: 200px;">
											<input type="text" style="width: 200px;" name="parameter[localtown_shop_address]" id="address"  data-val="true" data-val-required="请填写店铺所在详细地址" class="form-control" value="<?php echo ($data['localtown_shop_address']); ?>" data-rule-required="true"  />
										</div>
							...
							<div class="layui-input-block">
								<div class="dEdit_1">
									<div class="layui-inline">
										...
										<div class="layui-input-inline" style="width: 100px;">
											<input class="form-control input-sm" data-val="true"   id="lon" name="parameter[localtown_shop_lon]" readonly="readonly" type="text" value="<?php echo ($data['localtown_shop_lon']); ?>">
										</div>

										<div class="layui-input-inline" style="width: 100px;">
											<input class="form-control input-sm" data-val="true" id="lat" name="parameter[localtown_shop_lat]" readonly="readonly" type="text" value="<?php echo ($data['localtown_shop_lat']); ?>">
										</div>
									</div>
						...
						<div class="layui-form-item <?php if($is_supply == 1){ ?>layui-hide<?php } ?>" >
							...
							<div class="layui-input-block">
								<label class='radio-inline'>
									<input type='radio' title="开启"  name='parameter[localtown_business_hours_status]' value='1' <?php if(isset($data['localtown_business_hours_status']) && $data['localtown_business_hours_status'] == 1){ ?> checked<?php }else{ ?> <?php } ?> />
								</label>
								<label class='radio-inline'>
									<input type='radio' title="关闭" name='parameter[localtown_business_hours_status]' value='0' <?php if( !isset($data['localtown_business_hours_status']) || $data['localtown_business_hours_status'] == 0 ){ ?> checked<?php }else{ ?> <?php } ?>  />
								</label>
							</div>
							<div class="layui-form-mid layui-word-aux">开启后商城同城配送商品根据设置的营业时间段进行配送，其余时间段不进行配送</div>
						</div>
						<div class="layui-form-item <?php if($is_supply == 1){ ?>layui-hide<?php } ?>"">
							<label class="layui-form-label"></label>
							<div class="layui-input-block">
								<div class="input-group fixsingle-input-group">
									<div class="layui-input-inline">
										<input type="text" class="layui-input" name='parameter[localtown_business_hours_begin]' value='<?php echo $data[localtown_business_hours_begin];?>' id="business_hour_1" placeholder="HH:mm" lay-key="5">
									</div>
									<div class="layui-input-inline" style="width: 20px;">
										至
									</div>
									<div class="layui-input-inline">
										<input type="text" class="layui-input" name='parameter[localtown_business_hours_end]' value='<?php echo $data[localtown_business_hours_end];?>' id="business_hour_2" placeholder="HH:mm" lay-key="6">
									</div>
								</div>
								<span class='layui-form-mid layui-word-aux'>请完善营业时间信息。如果开始时间大于结束时间：例如06:00至2:00，则系统会默认营业时间为当天6:00至下一天2:00。</span>
							</div>
						</div>
						...
						<div class="layui-form-item <?php if($is_supply == 1){ ?>layui-hide<?php } ?>"">
							...
							<div class="layui-input-block">
								<div class="input-group fixsingle-input-group">
									...
									<input class="form-control" name="parameter[localtown_delivery_space_time]" type="text" placeholder="" value="<?php echo ($data['localtown_delivery_space_time']); ?>">
...
layui.use(['jquery', 'layer','form','laydate'], function(){
  ...
  form.on('submit(formDemo)', function(data){
	   ...
	   value = $('#servvice_maxdistance').val();
	  if (value == '' || value<1){
		layer.msg('服务距离不能为空，最小值是1',{icon: 2,time: 2000});
	  	return false;
	  }

	  //res = $('#fixed_deliverymoney,#fixed_money,#fixed_freemoney').val();
	  fixed_money = $('#fixed_money').val();
	  if (fixed_money == '' ) {
		  layer.msg('配送费不能为空',{icon: 2,time: 2000});
		  return false;
	  }

	  fixed_deliverymoney = $('#fixed_deliverymoney').val();
	  if (fixed_deliverymoney == '' ) {
		  layer.msg('起送价格不能为空',{icon: 2,time: 2000});
		  return false;
	  }
	  
	  var reg = /^(?!0+$)(?!0*\.0*$)\d{1,8}(\.\d{1,2})?$/;
	  if(!reg.test( fixed_deliverymoney )){
		  layer.msg('起送价格最多使用小数点后两位',{icon: 2,time: 2000});
		  return false;
	}
	  ...
	  fixed_freemoney = $('#fixed_freemoney').val();
	  if (fixed_freemoney == '' ) {
		  layer.msg('免配送费不能为空',{icon: 2,time: 2000});
		  return false;
	  }
...
<script>
    ...
    <?php if( !empty($data['localtown_shop_lat']) ){ ?>
            var center = new qq.maps.LatLng(<?php echo ($data['localtown_shop_lat']); ?>,<?php echo ($data['localtown_shop_lon']); ?>);
        <?php }else{?>
...
<script language='javascript'>
    $(function(){
        cascdeInit("1","1","<?php echo ($data['province_name']); ?>","<?php echo ($data['city_name']); ?>","<?php echo ($data['area_name']); ?>","<?php echo ($data['country_name']); ?>");
        initMap();//初始化门店地图
    });
