...
<div class="layui-fluid">
	<div class="layui-card">
		<div class="layui-card-header layui-elem-quote">当前位置：<span class="line-text">订阅消息设置</span></div>
			...
			<form action="" method="post" class="layui-form" lay-filter="component-layui-form-item" enctype="multipart/form-data" >
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="parameter[weprogram_subtemplate_pay_order]" class="layui-input" value="<?php echo ($data['weprogram_subtemplate_pay_order']); ?>" />
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">订单发货通知</label>
					<div class="layui-input-block">
						<input type="text" name="parameter[weprogram_subtemplate_send_order]" class="layui-input" value="<?php echo ($data['weprogram_subtemplate_send_order']); ?>" />
					</div>
				</div>
				<div class="layui-form-item" >
					<label class="layui-form-label">核销成功通知</label>
					<div class="layui-input-block">
						<input type="text" name="parameter[weprogram_subtemplate_hexiao_success]" class="layui-input" value="<?php echo ($data['weprogram_subtemplate_hexiao_success']); ?>" />
					</div>
				</div>
				<div class="layui-form-item" style="display:none;">
					<label class="layui-form-label">退款成功通知</label>
					<div class="layui-input-block">
						<input type="text" name="parameter[weprogram_subtemplate_refund_order]" class="layui-input" value="<?php echo ($data['weprogram_subtemplate_refund_order']); ?>" />
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">团长申请成功发送通知</label>
					<div class="layui-input-block">
						<input type="text" name="parameter[weprogram_subtemplate_apply_community]" class="layui-input" value="<?php echo ($data['weprogram_subtemplate_apply_community']); ?>" />
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="parameter[weprogram_subtemplate_open_tuan]" class="layui-input" value="<?php echo ($data['weprogram_subtemplate_open_tuan']); ?>" />
					</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="parameter[weprogram_subtemplate_take_tuan]" class="layui-input" value="<?php echo ($data['weprogram_subtemplate_take_tuan']); ?>" />
					</div>
					<div class="layui-form-mid">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="parameter[weprogram_subtemplate_pin_tuansuccess]" class="layui-input" value="<?php echo ($data['weprogram_subtemplate_pin_tuansuccess']); ?>" />
					</div>
					<div class="layui-form-mid">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="parameter[weprogram_subtemplate_apply_tixian]" class="layui-input" value="<?php echo ($data['weprogram_subtemplate_apply_tixian']); ?>" />
					</div>
					<div class="layui-form-mid">
						<!--<a href="https://shiziyu.liofis.com/订阅消息模板.docx" style="color:blue;">点击下载设置教程</a>
						&nbsp;&nbsp;&nbsp;&nbsp;-->
						需开通小程序类目：商家自营------>服装/鞋/箱包 、 生活服务---->百货/线下超市/便利店
					</div>
				</div>
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						...
						&nbsp;
						<input type="submit" value="一键获取" lay-submit lay-filter="sub_auto_get" class="btn btn-primary"  />
					</div>
				</div>
			</form>
		</div>
